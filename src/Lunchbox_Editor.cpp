...
int main(int, char**)
{
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        //auto physTimeStart = std::chrono::high_resolution_clock::now();

        physicsSystem->Update(dt);

        //auto physTimeStop = std::chrono::high_resolution_clock::now();

        //dt = std::chrono::duration<float, std::chrono::microseconds::period>(physTimeStop - physTimeStart).count();
        //std::cout << "Physics took: " << dt << "\n";
